...
class TrackerActivities extends StatefulWidget {
  const TrackerActivities({super.key});

  @override
  State<TrackerActivities> createState() => _TrackerActivitiesState();
}

class _TrackerActivitiesState extends State<TrackerActivities> {
